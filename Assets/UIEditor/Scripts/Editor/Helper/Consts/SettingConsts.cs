namespace Editor.UIEditor
{
    public static class SettingConsts
    {
        public static class Assistant {
            ...
            public const string GUIDE_COLOR = "UIEditor.Setting.Assistant.GuideColor";
        }
        
        public static class UIPrefabs
        {
            public const string ATOM_PATH = "UIEditor.Setting.UIPrefabs.AtomPath";
            public const string MODULE_PATH = "UIEditor.Setting.UIPrefabs.ModulePath";
        }
    }
}